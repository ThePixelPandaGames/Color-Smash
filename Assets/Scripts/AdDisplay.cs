...
{
    public string myGameIdAndroid = "5485243";
    public string myGameIdIOS = "5485242";
    ...
    {
        if (adUnitId.Equals(myAdUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
